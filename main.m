...
for Epi=1:Episode
    ...
    while (Terminal==0)
        ...
        robot_data(m)=robot_t_1.x;robot_data(m+M)=robot_t_1.y;robot_data(m+2*M)=robot_t_1.t;
        ...
        % end
        [a,Wt,J]= Q_learning(a,W,robot_t_1,robot_t,goal,laser,R,Terminal,guess_alpha(guess));
        W = Wt;
